...
const BasicInfoSection = ({
  formik,
  setRatingOverallRatingStars,
  overallRatingStars,
  setRatingHostStars,
  hostRatingStars,
  setRatingTasteStars,
  tasteRatingStars,
  setRatingLocationStars,
  locationRatingStars,
  setRatingVtmrStars,
  vtmrRatingStars,
  setRatingExperienceStars,
    ...
    <>
      ...
      <div className="row">
        <div className="col text-center">
          <Rating
            rating={overallRatingStars}
            onRating={(rate) => setRatingOverallRatingStars(rate)}
          />
        </div>
        <div className="col text-center">
      ...
      <div className="row">
        ...
        <div className="col text-center">
          <Rating
            rating={experienceRatingStars}
            onRating={(rate) => setRatingExperienceStars(rate)}
          />
        </div>
      </div>
      ...
      <Form.Group as={Col} controlId="overallRating">
        <Form.Control
          ...
          className={
            formik.touched.overallRating && formik.errors.overallRating ? 'form-error mt-4' : 'mt-4'
          }
        />
